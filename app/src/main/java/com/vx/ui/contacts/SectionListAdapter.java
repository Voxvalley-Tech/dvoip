...
public class SectionListAdapter extends BaseAdapter implements ListAdapter {
    ...
    public SectionListAdapter(Context context,final LayoutInflater inflater,
            final ListAdapter linkedAdapter, ArrayList<ContactsModel> contactsarray) {
    ...
    private synchronized void updateSessionCache() {
        ...
        for (int i = 0; i < count; i++) {
            ...
            //final String item = linkedAdapter.getItem(i).toString().substring(0, 1).toUpperCase(Locale.ENGLISH);
            final String item = contactsarray.get(i).getContactName().toString().substring(0, 1).toUpperCase(Locale.ENGLISH);
 ...
 setSectionText(section, theView);
    ...
    //    Typeface font = Typeface.createFromAsset(mContext.getAssets(), "Arkitech Medium.ttf");
    ...
    protected View createNewSectionView() {
        return inflater.inflate(R.layout.adapter_contacts_section_view, null);
    }
    ...
    //	Log.i("SectionListAdapter","value search is "+firstVisibleItem);
